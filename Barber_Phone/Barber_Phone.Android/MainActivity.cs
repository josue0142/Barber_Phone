...
{
    [Activity(Label = "BarberPhoneRD!", Icon = "@drawable/Barber02", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
