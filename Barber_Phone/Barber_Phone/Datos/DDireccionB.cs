...
namespace Barber_Phone.Datos
{
    class DDireccionB
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<DireccionB>> GetDireccionB()
        {
            HttpClient client = GetClient();
            const string URL = "https://bookshop2.000webhostapp.com/WebServicesXamarin/PostCitas/GetDireccionB.php";
